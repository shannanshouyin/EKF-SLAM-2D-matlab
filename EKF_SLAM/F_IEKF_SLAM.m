...
first_obs = struct('pos', zeros(size(est_state,1),1), 'robot_pose', zeros(3,1),...
...
for t = 0:dt:sim_time
    ...
    %% EKF更新步骤
    [est_state, P, first_obs] = f_Iekf_update_B(est_state, covariance ,measurements, measure_noise, first_obs);
